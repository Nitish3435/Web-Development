    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">DataTables For Feedback</h6>
            </div>
            <div class="card-body">
        ...
        <%while(rs.next())
        {
            %>
            <tr>
              <td><a href="up.jsp?year=<%=rs.getString("year") %>">UPDATE</a></td>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; survey.silicon.in 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
